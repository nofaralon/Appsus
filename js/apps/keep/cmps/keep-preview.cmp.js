...
export default {
    props: ['keep'],
    template:`
    <section v-if="cmpType" :style="keep.style" :class="keepLabel">
    <button class="remove-btn" @click="removeKeep">X</button>
        <component :is="cmpType" :keep="keep" @save="saveKeeps"></component>
    ...
    created(){
        ...
        console.log(this.keep.style.backgroundColor);
