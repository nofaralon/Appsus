export default {
    template: `
        <section class="mail-side-bar">
            <div class="side-bar">
                <div @click="openNewMail" class="side-bar-btn">
                    <img src="images/addMail.png" >                
                    <button>Add New Mail</button>
                </div>
                <div @click="openInbox" @class="side-bar-btn">
                ...
                <div @click="openDrafts" class="side-bar-btn">
                ...
                <div @click="openTrash" class="side-bar-btn">
